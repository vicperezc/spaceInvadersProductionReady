...
Invaders.MechanicFive = function () {
    ...
    // playerHitsInvadersShuffleTeam Variables
    this.arrPositionsX = [];
    this.arrPositionsY = [];
...
Invaders.MechanicFive.prototype = {
    ...
    playerHitsInvadersShuffleTeam: function () {

        var arr24 = [];
        while(arr24.length < 60){

            var randomnumber2=Math.floor(Math.random()*(59+1)); //  Math.floor(Math.random()*(max-min+1)+min);
            var found2=false;
        ...
        for (var i = 0; i < 60; i++) {
            ...
            invadersMoving.to({
                ...
                x: this.arrPositionsX[arr24[i]],
                y: this.arrPositionsY[arr24[i]]
            }, 1000, Phaser.Easing.Linear.None, false);

            invadersMoving.start();

        }
        //invadersMoving.onStart.add(function () {this.damageTweenStart();},this);
        //invadersMoving.onComplete.add(function () {this.damageTweenComplete();},this);
    ...
    randomFunctionDisparador: function () {
        ...
        // Movimientos
        this.playerHitsInvadersShuffleTeam();
    ...
    render: function () {
        ...
        this.game.debug.text('M5 Counter: ' + this.counter,20,80);
