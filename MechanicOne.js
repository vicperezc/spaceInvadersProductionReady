...
Invaders.MechanicOne.prototype = {
    ...
    create: function () {
        ...
        //this.time.events.repeat(20000, 5, this.ufoExtra, this);
    ...
    tweenInvaders: function () {
        ...
        if (this.invadersGroup.countLiving() > 0 && this.spaceship.alive && this.counter < 130) {
            var arrNotas = [
                this.nota1,
                this.nota2,
                this.nota3,
        ...
        } else if (this.invadersGroup.countLiving() > 0 && this.spaceship.alive && this.counter == 130){
    ...
    ufoNormal: function () {
        ...
        // TODA ESTA LOGICA SE VA A EJECUTAR SI NUESTRO PLAYER ESTA ALIVE
        if(this.spaceship.alive == true && this.counter < 264 && this.invadersGroup.countLiving() !== 0){
            this.world.add(this.ufo);
            this.tweenUfo = this.add.tween(this.ufo);
            this.tweenUfo.to( { x: 1100 }, 8000, Phaser.Easing.Linear.None, false, 100, 0, false);
            this.tweenUfo.start();


            this.tweenUfo.onStart.add(function () {this.ufoS.play()},this);
            // Evento (funcion) que se dispara cada vez que termina el tween.
            this.tweenUfo.onComplete.add(function () {this.ufoS.stop()},this);
            this.tweenUfo.onComplete.add(function () {this.ufo.kill()},this);
            //this.tweenUfo.onComplete.add(function () {this.ufo.revive()},this);


            //onKilled Signal
            //Se pone 'events' por que onKilled pertenece a phaser/src/gameobjects/components/Events.js
            this.ufo.events.onKilled.add(function () {this.ufoS.stop()}, this);
    ...
    playerHitsInvaders: function (enemy, bullet) {
        ...
        if (this.invadersGroup.countLiving() == 0 && this.spaceship.alive) {
            //score += 1000;
            enemy.damage(0);
            this.youWin();
        }
    ...
    youWin: function () {
        ...
        Invaders.youWin1 = true;

        //var storeLevel = true;
        //localStorage.setItem('storeLevel', 'true');
    ...
    render: function () {
        ...
        //this.invaderBullet.debug(20,120,true);
