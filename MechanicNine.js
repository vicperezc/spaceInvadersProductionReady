...
Invaders.MechanicNine = function () {
    ...
    this.counterDisparadorA = 0;
    this.counterDisparadorB = 0;
    this.invadersMovingC = null;
    this.invadersMovingC2 = null;
    this.invadersMovingC3 = null;
    this.counterFireC = 0;
    this.randomFire = null;

};
Invaders.MechanicNine.prototype = {
    ...
    create: function () {
        ...
        this.invaderBulletC.bulletSpeed = 450;
    ...
    playerHitsInvadersMoveToObject: function () {
        ...
        for (var i = 0; i < 60; i++) {
            ...
            invadersMoving.to({
                ...
                x: [this.arrPositionsX[0] - 100,-200,aRX[1],aRX[2],400,this.arrPositionsX[i]],
                y: [this.arrPositionsY[0],aRY[0],aRY[1],aRY[2],aRY[3],this.arrPositionsY[i]]
            }, 4000, Phaser.Easing.Linear.None, false, this.delayTween, 0, false).interpolation(function (v, k) {
                return Phaser.Math.catmullRomInterpolation(v, k);
            });
            ...
            //this.invaderBullet.trackSprite(this.invadersGroup.children[i],0,20,false);
            //this.invaderBullet.fireAngle = 90;
            //invadersMoving.onStart.add(function () {this.invaderBullet.fire();}, this);
            //invadersMoving.onStart.add(function () {this.enemyFires();}, this);
            /*
             if(invadersMoving.isRunning){
    ...
    enemyFiresA: function () {
        ...
        //this.invaderBullet.trackSprite(navesVivas[0],0,20,false);



        this.invaderBullet.trackSprite(navesVivas[this.counterDisparadorA],0,20,false);
        this.counterDisparadorA++;
        /*
         if (this.counterDisparadorA == 20){
         this.counterDisparadorA = 0;
         }*/
    ...
    playerHitsInvadersMoveToObjectA: function () {
        ...
        for (var i = 0; i < 20; i++) {
            ...
            if (this.randomFire == 0){
                ...
                if (this.invadersGroup.children[i].alive){

                    invadersMovingA.onStart.add(function () {this.enemyFiresA();}, this);
                }
            }
        ...
        //PARA QUE EL DISPARADOR SIEMPRE INTERACCJIONE DESDE EL INDICE 0
        this.counterDisparadorA = 0;
    ...
    enemyFiresB: function () {
        ...
        this.invaderBulletB.trackSprite(navesVivas[this.counterDisparadorB],0,20,false);
        this.counterDisparadorB++;

        //this.counterDisparadorB = 19 - navesVivas.length;
    ...
    playerHitsInvadersMoveToObjectB: function () {
        ...
        for (var i = 39; i > 19; i--) {
            ...
            invadersMovingB.to({
                ...
                x: [this.arrPositionsX[0] + 500,-200,aRX[1],aRX[2],400,this.arrPositionsX[i]],
                y: [this.arrPositionsY[0],aRY[0],aRY[1],aRY[2],aRY[3],this.arrPositionsY[i]]
            }, 4000, Phaser.Easing.Linear.None, false, this.delayTween, 0, false).interpolation(function (v, k) {
                return Phaser.Math.catmullRomInterpolation(v, k);
            });
            ...
            if (this.randomFire == 1){
                ...
                if (this.invadersGroup.children[i].alive){
                    ...
                    invadersMovingB.onStart.add(function () {this.enemyFiresB();}, this);
                }
            }
    ...
    enemyFiresC: function () {
        ...
        //this.counterDisparadorB = 19 - navesVivas.length;
        /*
         if (this.invadersMovingC.isRunning == true){


         }*/
        var pattern =  Phaser.ArrayUtils.numberArrayStep(45, 155, 5);
        ...
        if (navesVivas.length > 0){
            ...
            //***VAN JUNTAS
            this.invaderBulletC.fireAngle = pattern[this.counterFireC++];
            this.invaderBulletC.fire();
            if (this.counterFireC == 21){
                this.counterFireC = 0
            }
        }
    ...
    playerHitsInvadersMoveToObjectC: function () {
        ...
        //Campo de fuerza Moving
        var campoDeFuerzaMoving = null;
        var campoDeFuerzaMoving2 = null;
        var campoDeFuerzaMoving3 = null;
        for (var i = 40; i < 60; i++) {
            ...
            this.invadersMovingC.to({
                ...
                x: [this.arrPositionsX[0] + 270],
                y: [this.arrPositionsY[0] - 50]
            }, 1000, Phaser.Easing.Linear.None, false, 0, 0, false).interpolation(function (v, k) {
                return Phaser.Math.catmullRomInterpolation(v, k);
            });

            this.invadersMovingC2 = this.add.tween(this.invadersGroup.children[i]);
            //invaderFall = this.add.tween(this.item);
            this.invadersMovingC2.to({

                x: [270],
                y: [this.arrPositionsY[0]]
            }, 8200, Phaser.Easing.Linear.None, false, 0, 0, false).interpolation(function (v, k) {
                return Phaser.Math.catmullRomInterpolation(v, k);
            });

            this.invadersMovingC3 = this.add.tween(this.invadersGroup.children[i]);
            //invaderFall = this.add.tween(this.item);
            this.invadersMovingC3.to({

                x: [this.arrPositionsX[i]],
                y: [this.arrPositionsY[i]]
            }, 1000, Phaser.Easing.Linear.None, false, 0, 0, false).interpolation(function (v, k) {
                return Phaser.Math.catmullRomInterpolation(v, k);
            });

            this.invadersMovingC.chain(this.invadersMovingC2, this.invadersMovingC3);
            ...
            campoDeFuerzaMoving2 = this.add.tween(this.campoDeFuerzaGroup.children[i]);
            //invaderFall = this.add.tween(this.item);
            campoDeFuerzaMoving2.to({
            ...
            campoDeFuerzaMoving3 = this.add.tween(this.campoDeFuerzaGroup.children[i]);
            //invaderFall = this.add.tween(this.item);
            campoDeFuerzaMoving3.to({
            ...
            campoDeFuerzaMoving.chain(campoDeFuerzaMoving2,campoDeFuerzaMoving3);
            campoDeFuerzaMoving.start();
    ...
    randomFunctionDisparador: function () {
        ...
        //Para que algunas veces dispare el Grupo A o B pero no juntos
        this.randomFireAorB();
        // Movimientos
    ...
    randomFireAorB: function () {
        this.randomFire = Math.floor(Math.random()*(1+1));
    },
    ...
    update: function () {
        ...
        if (this.spaceship.alive && this.counter < 264){
            ...
            if (this.game.time.totalElapsedSeconds().toFixed(0) > 2){
                ...
                if (this.time.now > this.firingTimer && this.spaceship.alive && this.counter < 264 && this.invadersMovingC2.isRunning) {
    ...
    render: function () {
        ...
        this.game.debug.text('M9 Counter: ' + this.counter,20,80);
        ...
        this.game.debug.text('randomFire: ' + this.randomFire,20,140);
