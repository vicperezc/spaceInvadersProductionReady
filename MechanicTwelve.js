...
Invaders.MechanicTwelve = function () {
...
Invaders.MechanicTwelve.prototype = {
    ...
    playerHitsInvadersMoveToObjectA: function () {
        ...
        this.fBLRosaCounter+=1;
        if (this.fBLRosaCounter == 1){
            this.fBLRosas = 20;
        }else if (this.fBLRosaCounter == 2){
            this.fBLRosas = 40;
        }else if (this.fBLRosaCounter == 3){
            this.fBLRosas = 0;
        }

        if(this.fBLRosaCounter == 3){
            this.fBLRosaCounter = 0;
        }
        ...
        for (var i = 0; i < 20; i++) {
            ...
            invadersMovingA.to({
                ...
                x: [this.arrPositionsX[i],this.arrPositionsX[i + this.fBLRosas]],
                y: [this.arrPositionsY[i] - 50,this.arrPositionsY[i + this.fBLRosas]]
            }, 2000, Phaser.Easing.Linear.None, false, this.delayTween, 0, false).interpolation(function (v, k) {
                return Phaser.Math.catmullRomInterpolation(v, k);
            });
    ...
    playerHitsInvadersMoveToObjectB: function () {
        ...
        this.fBLAzulCounter+=1;
        if (this.fBLAzulCounter == 1){
            this.fBLAzules = 20;
        }else if (this.fBLAzulCounter == 2){
            this.fBLAzules = -20;
        }else if (this.fBLAzulCounter == 3){
            this.fBLAzules = 0;
        }

        if(this.fBLAzulCounter == 3){
            this.fBLAzulCounter = 0;
        }
        ...
        for (var i = 20; i < 40; i++) {
            ...
            invadersMovingB.to({
                ...
                x: [this.arrPositionsX[i] - 300,this.arrPositionsX[i + this.fBLAzules]],
                y: [this.arrPositionsY[i],this.arrPositionsY[i + this.fBLAzules]]
            }, 2000, Phaser.Easing.Linear.None, false, this.delayTween, 0, false).interpolation(function (v, k) {
                return Phaser.Math.catmullRomInterpolation(v, k);
            });
    ...
    playerHitsInvadersMoveToObjectC: function () {
        ...
        this.fBLVerdeCounter+=1;
        if (this.fBLVerdeCounter == 1){
            this.fBLVerdes = -40;
        }else if (this.fBLVerdeCounter == 2){
            this.fBLVerdes = -20;
        }else if (this.fBLVerdeCounter == 3){
            this.fBLVerdes = 0;
        }
        if(this.fBLVerdeCounter == 3){
            this.fBLVerdeCounter = 0;
        }
        ...
        for (var i = 40; i < 60; i++) {
            ...
            this.invadersMovingC.to({
                ...
                x: [this.arrPositionsX[40],500,this.arrPositionsX[i + this.fBLVerdes]],
                y: [-50 ,-80,this.arrPositionsY[i + this.fBLVerdes]]
            }, 2000, Phaser.Easing.Linear.None, false, this.delayTween, 0, false).interpolation(function (v, k) {
                return Phaser.Math.catmullRomInterpolation(v, k);
            });
    ...
    randomFunctionDisparador: function () {
        ...
        var item = arrayTime[Math.floor(Math.random() * arrayTime.length)];
        this.randomTimer = this.time.now + item;
    ...
    render: function () {
        ...
        this.game.debug.text('M12 Counter: ' + this.counter,20,80);
