...
Invaders.MechanicThirteen = function () {
    ...
    this.fBLRosaCounter = 0;
    this.fBLAzulCounter = 0;
    this.fBLVerdeCounter = 0;
    this.fBLRosas = null;
    this.fBLAzules = null;
    this.fBLVerdes = null;

    this.noKillTweeningA = null;
    this.noKillTweeningB = null;
    this.noKillTweeningC = null;
    this.invadersGroupA = [];
    this.invadersGroupB = [];
    this.invadersGroupC = [];
    this.campoGroupA = [];
    this.campoGroupB = [];
    this.campoGroupC = [];
    this.firingTimerBulletA = 0;
    this.firingTimerBulletB = 0;
    this.firingTimerBulletC = 0;
...
Invaders.MechanicThirteen.prototype = {
    ...
    createInvaders: function () {
        ...
        // Invaders Group Individual
        for (i = 0; i < 20; i++){
            this.invadersGroupA.push(this.invadersGroup.children[i])

        }
        for (i = 20; i < 40; i++){
            this.invadersGroupB.push(this.invadersGroup.children[i])

        }
        for (i = 40; i < 60; i++){
            this.invadersGroupC.push(this.invadersGroup.children[i])
    ...
    createCampoDeFuerza: function () {
        ...
        // Campos Group Individual
        for (i = 0; i < 20; i++){
            this.campoGroupA.push(this.campoDeFuerzaGroup.children[i])

        }
        for (i = 20; i < 40; i++){
            this.campoGroupB.push(this.campoDeFuerzaGroup.children[i])

        }
        for (i = 40; i < 60; i++){
            this.campoGroupC.push(this.campoDeFuerzaGroup.children[i])
    ...
    enemyFiresA: function () {
        ...
        this.firingTimerBulletA = this.time.now + item;
    ...
    enemyFiresB: function () {
        ...
        var item = firingTimerRandom[Math.floor(Math.random() * firingTimerRandom.length)];
        // Esto significa que vamos a disparar cada 1000 ms o cada segundo
        this.firingTimerBulletB = this.time.now + item;
    ...
    enemyFiresC: function () {
        ...
        var item = firingTimerRandom[Math.floor(Math.random() * firingTimerRandom.length)];
        // Esto significa que vamos a disparar cada 1000 ms o cada segundo
        this.firingTimerBulletC = this.time.now + item;


    },

    canKillInvadersA: function (enemy,bullet) {

        //                         PARAMETRO PARA QUE NO LOS PUEDAN MATAR MIENTRAS SE HACEN PEQUEÑOS
        if (enemy.alive == true && this.noKillTweeningA.isRunning == false){
    ...
    canKillCampoA: function (campo,bullet) {
        //                         PARAMETRO PARA QUE NO LOS PUEDAN MATAR MIENTRAS SE HACEN PEQUEÑOS
        if (campo.alive == true && this.noKillTweeningA.isRunning == false){
    ...
    canNotKillInvadersA: function () {
        //Campo de fuerza Moving
        var campoDeFuerzaMoving = null;

        for (var i = 0; i < 20; i++) {
            //                                                              this.invadersIndex++
            this.noKillTweeningA = this.add.tween(this.invadersGroup.children[i].scale);
            this.noKillTweeningA.to({
                x:[.1,.1,.1,1],
                y: [.1,.1,.1,1]},2000, Phaser.Easing.Linear.None,false);
            this.noKillTweeningA.start();

            campoDeFuerzaMoving = this.add.tween(this.campoDeFuerzaGroup.children[i].scale);
        ...
        this.firingTimerA = this.time.now + arrayTime[x];

    },

    canKillInvadersB: function (enemy,bullet) {

        //                         PARAMETRO PARA QUE NO LOS PUEDAN MATAR MIENTRAS SE HACEN PEQUEÑOS
        if (enemy.alive == true && this.noKillTweeningB.isRunning == false){
    ...
    canKillCampoB: function (campo,bullet) {
        //                         PARAMETRO PARA QUE NO LOS PUEDAN MATAR MIENTRAS SE HACEN PEQUEÑOS
        if (campo.alive == true && this.noKillTweeningB.isRunning == false){
    ...
    canNotKillInvadersB: function () {

        var campoDeFuerzaMoving = null;

        for (var i = 20; i < 40; i++) {
            //                                                              this.invadersIndex++
            this.noKillTweeningB = this.add.tween(this.invadersGroup.children[i].scale);
            this.noKillTweeningB.to({
                x:[.1,.1,.1,1],
                y: [.1,.1,.1,1]},2000, Phaser.Easing.Linear.None,false);
            this.noKillTweeningB.start();
        ...
        var x = Math.floor(Math.random()*(2+1));
        this.firingTimerB = this.time.now + arrayTime[x];

    },

    canKillInvadersC: function (enemy,bullet) {

        //                         PARAMETRO PARA QUE NO LOS PUEDAN MATAR MIENTRAS SE HACEN PEQUEÑOS
        if (enemy.alive == true && this.noKillTweeningC.isRunning == false){
    ...
    canKillCampoC: function (campo,bullet) {
        //                         PARAMETRO PARA QUE NO LOS PUEDAN MATAR MIENTRAS SE HACEN PEQUEÑOS
        if (campo.alive == true && this.noKillTweeningC.isRunning == false){
    ...
    canNotKillInvadersC: function () {

        var campoDeFuerzaMoving = null;

        for (var i = 40; i < 60; i++) {
            //                                                              this.invadersIndex++
            this.noKillTweeningC = this.add.tween(this.invadersGroup.children[i].scale);
            this.noKillTweeningC.to({
                x:[.1,.1,.1,1],
                y: [.1,.1,.1,1]},2000, Phaser.Easing.Linear.None,false);
            this.noKillTweeningC.start();
        ...
        var x = Math.floor(Math.random()*(2+1));
        this.firingTimerC = this.time.now + arrayTime[x];
    ...
    update: function () {
        ...
        if (this.spaceship.alive && this.counter < 264){
            ...
            if (this.game.time.totalElapsedSeconds().toFixed(0) > 1){
                ...
                if (this.time.now > this.firingTimerBulletA && this.spaceship.alive && this.counter < 264 ) {
                    this.enemyFiresA();

                }
                if (this.time.now > this.firingTimerBulletB && this.spaceship.alive && this.counter < 264 ) {
                    this.enemyFiresB();
                }
                if (this.time.now > this.firingTimerBulletC && this.spaceship.alive && this.counter < 264) {
        ...
        //canNotKillInvaders INVADERS LOGICA

        this.physics.arcade.overlap(this.campoGroupA, this.bulletRed.bullets,this.canKillCampoA,null,this);
        this.physics.arcade.overlap(this.campoGroupB, this.bulletRed.bullets,this.canKillCampoB,null,this);
        this.physics.arcade.overlap(this.campoGroupC, this.bulletRed.bullets,this.canKillCampoC,null,this);

        this.physics.arcade.overlap(this.invadersGroupA, this.bulletRed.bullets,this.canKillInvadersA,null,this);
        this.physics.arcade.overlap(this.invadersGroupB, this.bulletRed.bullets,this.canKillInvadersB,null,this);
        this.physics.arcade.overlap(this.invadersGroupC, this.bulletRed.bullets,this.canKillInvadersC,null,this);

         //canNotKillInvaders FUNCTION
         if (this.time.now > this.firingTimerA && this.spaceship.alive && this.counter < 264){
         this.canNotKillInvadersA();
         }
         if (this.time.now > this.firingTimerB && this.spaceship.alive && this.counter < 264){
         this.canNotKillInvadersB();
         }
         if (this.time.now > this.firingTimerC && this.spaceship.alive && this.counter < 264){
         this.canNotKillInvadersC();
         }
    ...
    render: function () {
        ...
        this.game.debug.text('M13 Counter: ' + this.counter,20,80);
