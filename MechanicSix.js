...
Invaders.MechanicSix = function () {
    ...
    // playerHitsInvadersShuffleScale Variables
    this.arrPositionsX = [];
    this.arrPositionsY = [];
...
Invaders.MechanicSix.prototype = {
    ...
    playerHitsInvadersShuffleScale: function () {
        ...
        for (var i = 0; i < 60; i++) {
            ...
            growing.to({
                x:[0.1,0.1,0.1,1],
                y: [0.1,0.1,0.1,1]},2000, Phaser.Easing.Linear.None,false);
            growing.start();
    ...
    randomFunctionDisparador: function () {
        ...
        // Movimientos
        this.playerHitsInvadersShuffleScale();
        var arrayTime = [
            1000,
            2000,
            4000
    ...
    render: function () {
        ...
        this.game.debug.text('M6 Counter: ' + this.counter,20,80);
