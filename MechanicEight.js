...
Invaders.MechanicEight = function () {
...
Invaders.MechanicEight.prototype = {
    ...
    playerHitsInvadersMoveToObjectA: function () {
        ...
        for (var i = 0; i < 20; i++) {
            ...
            }, 6500, Phaser.Easing.Linear.None, false, 0, 0, false).interpolation(function (v, k) {
                return Phaser.Math.catmullRomInterpolation(v, k);
            });
    ...
    playerHitsInvadersMoveToObjectB: function () {
        ...
        for (var i = 20; i < 40; i++) {
            ...
            invadersMovingB.to({
                ...
                x: [this.arrPositionsX[0] + 200,-100,aRX[1],aRX[2],400,this.arrPositionsX[i]],
                y: [this.arrPositionsY[0],aRY[0],aRY[1],aRY[2],aRY[3],this.arrPositionsY[i]]
            }, 6500, Phaser.Easing.Linear.None, false, 0, 0, false).interpolation(function (v, k) {
                return Phaser.Math.catmullRomInterpolation(v, k);
            });
    ...
    playerHitsInvadersMoveToObjectC: function () {
        ...
        for (var i = 40; i < 60; i++) {
            ...
            this.invadersMovingC.to({
                ...
                x: [this.arrPositionsX[0] + 600,-200,aRX[1],aRX[2],400,this.arrPositionsX[i]],
                y: [this.arrPositionsY[0],aRY[0],aRY[1],aRY[2],aRY[3],this.arrPositionsY[i]]
            }, 6500, Phaser.Easing.Linear.None, false, 0, 0, false).interpolation(function (v, k) {
                return Phaser.Math.catmullRomInterpolation(v, k);
            });
    ...
    render: function () {
        ...
        this.game.debug.text('M8 Counter: ' + this.counter,20,80);
